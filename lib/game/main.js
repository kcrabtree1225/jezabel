...
MyGame = ig.Game.extend({
	...
	spawnEnemy: function() {
		...
		enemies.push(ig.game.spawnEntity( EntityEnemy, this.xPos, this.yPos, {name: enemies.length} ));
	...
	getCoords: function() {
		...
		// this.xPos += (this.xPos10000)*Math.floor(Math.random() * (51 - 0)) + 0;
		// this.yPos += (this.yPos10000)*Math.floor(Math.random() * (51 - 0)) + 0;
